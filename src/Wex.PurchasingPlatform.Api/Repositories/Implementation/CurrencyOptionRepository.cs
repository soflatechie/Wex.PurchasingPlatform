...
public class CurrencyOptionRepository(AppDbContext context) : Repository<CurrencyOption>(context)
{
    public virtual async Task<IReadOnlyList<CurrencyOption>> GetByCountryAsync(string country, CancellationToken cancellationToken = default)
    {
    ...
    public virtual async Task ReplaceAllAsync(IReadOnlyList<CurrencyOption> options, CancellationToken cancellationToken = default)
    {
